    ...
    $(document).on('changed', function () {
        ...
        if ($(".varients").length) {
            $(".varients li a").on("click", function () {
                ...
                let target_slider = $('.single-product-box .big-product').find('.slick-slide.slick-current.slick-active');
        ...
        if ($(".increaseQty").length) {
            ...
            $(".increaseQty").on("click", function () {
                ...
                let value = $parentElm.find(".qtyValue").val();
                if (value < maxVal) {
                    value++;
                }
        ...
        if ($(".banner-one__single-slide").length) {
            ...
            function parallaxIt(e, target, movement) {
                let $this = $(".banner-one__single-slide");
