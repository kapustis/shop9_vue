            ...
            <div class="product-categories-one__inner">
              <ul>
                ...
                <li>
                  <a href="#0" class="img-box">
                    <div class="inner">
                      <img src="src/assets/images/shop/product-categories-v1-img3.png" alt=""/>
                    </div>
                  </a>
                  <div class="title">
                    <a href="#0">
                ...
                <li><a href="#0" class="img-box">
                  <div class="inner">
                    <img src="src/assets/images/shop/product-categories-v1-img4.png" alt=""/>
                  </div>
                </a>
                  <div class="title">
                    <a href="#0">
                ...
                <li><a href="#0" class="img-box">
                  <div class="inner">
                    <img src="src/assets/images/shop/product-categories-v1-img5.png" alt=""/>
                  </div>
                </a>
                  <div class="title">
                    <a href="#0">
                ...
                <li>
                  <a href="#0" class="img-box">
                    <div class="inner">
                      <img src="src/assets/images/shop/product-categories-v1-img6.png" alt=""/>
                    </div>
                  </a>
                  <div class="title">
                    <a href="#0">
              ...
              <div class="sidebar-holder">
                ...
                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                  ...
                  <ul class="color-option">
                    ...
                    <li><a href="#0" class="color-option-single bg2"> <span> Yellow</span> </a></li>
                    ...
                    <li><a href="#0" class="color-option-single bg5"> <span> Green</span> </a></li>
                    <li><a href="#0" class="color-option-single bg6"> <span> Olive</span> </a></li>
                    ...
                    <li><a href="#0" class="color-option-single bg10"> <span> Magenta</span> </a></li>
                  </ul>
                </div>
                <!--Color Option-->
