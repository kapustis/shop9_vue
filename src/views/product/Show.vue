...
<!--                  <p>(+15% Vat Included)</p>-->
                ...
                -->
                <div v-if="product.size" class="shop-details-top-size-box">
                  <h4>Size: (XS)</h4>
                ...
                <div class="shop-details-top-color-sky-box">
                  <h4>Color: ( {{ product.color.title }} )</h4>
                  <ul class="varients">
                    <li v-for="group_product in product.group_products">
                      <a
                          @click.prevent="getProduct(group_product.id)"
                          :href="`#${group_product.id}`"
                          class="shop-details-top-color-sky-img"
                          :style="`
                          background:${group_product.color.title};
                          width:70px;
                          height:70px;
                          `"
                      >
                ...
                -->
                <div v-if="timer_p" class="timer-box">
                  <h4>Running Offer</h4>
                ...
                <p class="shop-details-top-product-sale">
                  <span>20</span> Persons looking for this product
                </p>
                  ...
                  <ul class="shop-details-top-safe-checkout-list">
                    <li>
                      <div class="shop-details-top-safe-checkout-img">
                        <a href="#0">
                          <img src="/src/assets/images/shop/shop-details-top-safe-checkout-img-1.jpg" alt="">
                        </a>
                      </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img">
                        <a href="#0">
                          <img src="/src/assets/images/shop/shop-details-top-safe-checkout-img-2.jpg" alt="">
                        </a>
                      </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img">
                        <a href="#0">
                          <img src="/src/assets/images/shop/shop-details-top-safe-checkout-img-3.jpg" alt="">
                        </a>
                      </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img">
                        <a href="#0">
                          <img src="/src/assets/images/shop/shop-details-top-safe-checkout-img-4.jpg" alt="">
                        </a>
                      </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img">
                        <a href="#0">
                          <img src="/src/assets/images/shop/shop-details-top-safe-checkout-img-5.jpg" alt="">
                        </a>
                      </div>
                    </li>
                    <li>
                      <div class="shop-details-top-safe-checkout-img">
                        <a href="#0">
                          <img src="/src/assets/images/shop/shop-details-top-safe-checkout-img-7.jpg" alt="">
                        </a>
                      </div>
                    </li>
                  </ul>
      ...
      <div class="container">
        ...
        <div class="row wow fadeInUp animated">
          <div class="tab-content" id="pills-tabContent-two">
            ...
            <div
                class="tab-pane fade" id="pills-additional"
                role="tabpanel"
            ...
            >
              <div class="product-drescription">
                ...
                <ul class="drescription-list">
                  ...
                  <li>
                    2. Euismod disagree soler imperdiet vehicula pede eros ipsum cras mi feugiat.
                  </li>
                  <li>
                    3. Rhoncus consequat phasellus donec suspendisse scelerisque facilisis gravida
                    porttitor turpis.
                  </li>
                  <li>
            ...
            <div class="tab-pane fade" id="pills-review" role="tabpanel" aria-labelledby="pills-review-tab">
              <div class="product-drescription">
                ...
                <div class="review-single">
                  <div class="left">
                    <div class="ratting"><i class="flaticon-star-1"></i>
                      <i class="flaticon-star-1"></i>
                      <i class="flaticon-star-1"></i>
                      <i class="flaticon-star-1"></i>
                      <i class="flaticon-star-1"></i>
          ...
          <div class="catagory-slider">
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                >
                  <img src="/src/assets/images/shop/products-img1.jpg" alt="Alt">
                </a>
                <div class="products-grid__usefull-links">
                  <ul>
                    ...
                    <li>
                      <a href="#view-popup1" class="popup_link">
                          ...
                          <div class="popup-product-thumb-box">
                            <ul>
                              <li class="tab-nav popup-product-thumb">
                                <a href="#tab7">
                                  <img src="/src/assets/images/shop/products-img1.jpg" alt="img">
                                </a>
                              </li>
                              <li class="tab-nav popup-product-thumb ">
                                <a href="#tab8">
                                  <img src="/src/assets/images/shop/products-img2.jpg" alt="img">
                                </a>
                              </li>
                              <li class="tab-nav popup-product-thumb ">
                                <a href="#tab9">
                                  <img src="/src/assets/images/shop/products-img3.jpg" alt="img">
                                </a>
                              </li>
                            </ul>
                          </div>
              ...
              <div class="products-grid__content">
                ...
                <h5 class="product_name">
                  <a href="shop-details-1.html">Diamond Bracelet </a>
                </h5>
            ...
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                <div class="products-grid-one__badge-box">
                  <span class="bg_black badge discount">-20%</span>
                </div>
                ...
                <a href="shop-details-1.html" class="d-block products-grid__image_holder">
                  <img
                      ...
                      src="/src/assets/images/shop/products-img3.jpg" alt="Alt"
                  >
                  <img
                ...
                <div class="products-grid__usefull-links">
                  <ul>
                    ...
                    <li>
                      <a href="#view-popup2" class="popup_link">
                        <i class="flaticon-visibility"></i>
                        <span> quick view</span>
                      </a>
                    </li>
                        ...
                        <div class="tabs">
                          <div class="popup-product-thumb-box">
                            <ul>
                              ...
                              <li class="tab-nav popup-product-thumb ">
                                <a href="#tab888">
                                  <img src="/src/assets/images/shop/products-img4.jpg" alt="img">
                                </a>
                              </li>
                              <li class="tab-nav popup-product-thumb ">
                                <a href="#tab999">
                                  <img src="/src/assets/images/shop/products-img5.jpg" alt="img">
                                </a>
                              </li>
                            </ul>
                          </div>
                          ...
                          <div class="popup-product-main-image-box">
                            ...
                            <div id="tab999" class="tab-item popup-product-image">
                              <div class="popup-product-single-image">
                                <img src="/src/assets/images/shop/products-img6.jpg" alt="img">
                              </div>
                            </div>
                            <button class="prev">
                              <i class="flaticon-back"></i>
              ...
              <div class="products-grid__content">
                ...
                <h5 class="product_name">
                  <a href="shop-details-1.html"> Girl Diamond Ring </a>
                </h5>
                <div class="price d-flex align-content-center justify-content-center">
                  <p>$250</p>
                </div>
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient">
                  <span class="color"> Yellow </span>
                  <img src="/src/assets/images/shop/products-img3.jpg" alt="Alt">
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> blue </span>
                  <img src="/src/assets/images/shop/products-img4.jpg" alt="Alt">
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> Black </span>
                  <img src="/src/assets/images/shop/products-img5.jpg" alt="Alt">
                </p>
              </div>
            </div>
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                <div class="products-grid-one__badge-box">
                  <span class="bg_base badge new ">New</span>
                  <span class="bg_black badge discount">-30%</span>
                </div>
                <a href="shop-details-1.html" class="d-block products-grid__image_holder">
                  <img
                      class="products-grid-one__mainimage products-grid-one__first-img"
                ...
                <div class="products-grid__usefull-links">
                  <ul>
                    ...
                    <li>
                      <a href="#view-popup3" class="popup_link">
                        <i class="flaticon-visibility"></i>
                        <span> quick view</span>
                      </a>
                    </li>
              ...
              <div class="products-grid__content">
                ...
                <h5 class="product_name">
                  <a href="shop-details-1.html"> Women Earring Erl </a>
                </h5>
                <div class="price d-flex align-content-center justify-content-center">
                  <span class="pe-1"><del> $200.00</del></span>
                  <p>$160</p>
                </div>
              </div>
            ...
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                <div class="products-grid__usefull-links">
                  <ul>
                    ...
                    <li>
                      <a href="#view-popup4" class="popup_link">
                        <i class="flaticon-visibility"></i>
                        <span> quick view</span>
                      </a>
                    </li>
                        ...
                        <div class="tabs">
                          ...
                          <div class="popup-product-main-image-box">
                            ...
                            <div id="tab99999" class="tab-item popup-product-image">
                              <div class="popup-product-single-image">
                                <img src="/src/assets/images/shop/products-img7.jpg" alt="img">
                              </div>
                            </div>
              ...
              <div class="products-grid__content">
                <a href="cart.html" lass="products-grid__cart-btn btn--primary">
                  <span class="one"> Add to Cart </span>
                  <span class="two">
                    <i class="flaticon-shopping-cart"> </i>
                  </span>
                ...
                <h5 class="product_name">
                  <a href="shop-details-1.html"> Wedding Ring Men </a>
                </h5>
                <div class="price d-flex align-content-center justify-content-center">
                  <p>$200</p>
                </div>
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient">
                  <span class="color"> blue </span>
                  <img src="/src/assets/images/shop/products-img6.jpg" alt="Alt">
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> Yellow </span>
                  <img src="/src/assets/images/shop/products-img5.jpg" alt="Alt">
            ...
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                <div class="products-grid__usefull-links">
                  <ul>
                    ...
                    <li>
                      <a href="#view-popup5" class="popup_link">
                        <i class="flaticon-visibility"></i>
                        <span> quick view</span>
                      </a>
                    </li>
                    ...
                    <div class="col-lg-6">
                      <div class="popup-right-content">
                        ...
                        <div class="payment-method">
                          ...
                          <a href="#0">
                            <img rc="/src/assets/images/payment_method/method_3.png" alt="">
                          </a>
                          <a href="#0">
                            <img src="/src/assets/images/payment_method/method_4.png" alt="">
                          </a>
              ...
              <div class="products-grid__content">
                ...
                <h5 class="product_name">
                  <a href="shop-details-1.html"> Titan Locket Women </a>
                </h5>
                <div class="price d-flex align-content-center justify-content-center">
                  <p>$250</p>
                </div>
              ...
              <div class="products-grid-one__thumb-box">
                ...
                <p class="products-grid-one__product-varient">
                  <span class="color"> Yellow </span>
                  <img src="/src/assets/images/shop/products-img7.jpg" alt="Alt">
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> green </span>
                  <img src="/src/assets/images/shop/products-img8.jpg" alt="Alt">
                </p>
              </div>
            </div>
            ...
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                <a href="shop-details-1.html" class="d-block products-grid__image_holder">
                  <img
                      class="products-grid-one__mainimage products-grid-one__first-img"
                      src="/src/assets/images/shop/products-img12.jpg"
                      alt="Alt"
                  >
                  <img
                      class="products-grid-one__hover-img"
                ...
                <div class="products-grid__usefull-links">
                  <ul>
                    ...
                    <li>
                      <a href="#view-popup6" class="popup_link">
                        <i class="flaticon-visibility"></i>
                        <span> quick view</span>
                      </a>
                    </li>
                        ...
                        <div class="tabs">
                          <div class="popup-product-thumb-box">
                            <ul>
                              <li class="tab-nav popup-product-thumb">
                                <a href="#ttab111">
                                  <img src="/src/assets/images/shop/products-img9.jpg" alt="img">
                                </a>
                              </li>
                              <li class="tab-nav popup-product-thumb ">
                                <a href="#ttab222">
                                  <img src="/src/assets/images/shop/products-img10.jpg" alt="img">
                                </a>
                              </li>
                              <li class="tab-nav popup-product-thumb ">
                                <a href="#ttab333">
                                  <img src="/src/assets/images/shop/products-img11.jpg" alt="img">
                                </a>
                              </li>
                            </ul>
                          </div>
              ...
              <div class="products-grid__content">
                ...
                <h5 class="product_name">
                  <a href="shop-details-1.html">Gold Bracelet Girl </a>
                </h5>
                <div class="price d-flex align-content-center justify-content-center">
                  <p>$150</p>
                </div>
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient">
                  <span class="color"> Blue </span>
                  <img src="/src/assets/images/shop/products-img12.jpg" alt="Alt">
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> Green </span>
                  <img src="/src/assets/images/shop/products-img11.jpg" alt="Alt">
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> Black </span>
                  <img src="/src/assets/images/shop/products-img10.jpg" alt="Alt">
                </p>
              </div>
            </div>
          </div>
